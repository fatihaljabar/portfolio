...
export const techIcons: Record<string, { icon: IconType; color: string }> = {
  ...
  TypeScript: { icon: SiTypescript, color: '#4A88CD' },
  'Tailwind CSS': { icon: SiTailwindcss, color: '#06B6D4' },
  Hono: { icon: SiHono, color: '#E36002' },
  MySQL: { icon: SiMysql, color: '#5C8AAD' },
  React: { icon: SiReact, color: '#61DAFB' },
  Vite: { icon: SiVite, color: '#646CFF' },
  'Node.js': { icon: SiNodedotjs, color: '#339933' },
  'Next.js': { icon: SiNextdotjs, color: '#A3A3A3' },
  Python: { icon: SiPython, color: '#558BB8' },
  ...
  'Framer Motion': { icon: SiFramer, color: '#4080FF' },
  ...
  'React Router': { icon: SiReactrouter, color: '#D36265' },
};
