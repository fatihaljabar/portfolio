...
import { Award, Folder, Heart, Home, type LucideIcon, Mail, User } from 'lucide-react';
import { usePathname } from 'next/navigation';
import { useTranslations } from 'next-intl';
import { useEffect, useState } from 'react';
import { getLoveCount, hasLoved, toggleLove } from '@/lib/actions/love';
...
export function FloatingNav() {
  ...
  return (
    <div className="fixed bottom-[max(2rem,calc(env(safe-area-inset-bottom)+1rem))] inset-x-0 z-50 flex justify-center pointer-events-none">
      <div className="w-full max-w-[1300px] flex justify-center lg:pl-[380px]">
